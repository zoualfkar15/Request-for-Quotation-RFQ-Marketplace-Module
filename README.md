...
- Category subscriptions (used for offer/request targeting)
...
- **company1**: `company1@test.com` / `Password123!` / `company_name=Company One` / `phone=+966500000001`
- **company2**: `company2@test.com` / `Password123!` / `company_name=Company Two` / `phone=+966500000002`
